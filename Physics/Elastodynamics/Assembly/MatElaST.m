...
%>
%==========================================================================
%> @section classMatElaST Class description
%==========================================================================
%> @brief Assembly of the matrices for the elastic problem \cite AM2017
%
...
%% Initialization of the matrices
El.V1_loc = mat2cell(zeros(femregion.nbases,femregion.nbases,femregion.nel),femregion.nbases,femregion.nbases,ones(1,femregion.nel));
El.V2_loc = mat2cell(zeros(femregion.nbases,femregion.nbases,femregion.nel),femregion.nbases,femregion.nbases,ones(1,femregion.nel));
El.V3_loc = mat2cell(zeros(femregion.nbases,femregion.nbases,femregion.nel),femregion.nbases,femregion.nbases,ones(1,femregion.nel));
El.V4_loc = mat2cell(zeros(femregion.nbases,femregion.nbases,femregion.nel),femregion.nbases,femregion.nbases,ones(1,femregion.nel));

El.M1_P_rho_loc  = mat2cell(zeros(femregion.nbases,femregion.nbases,femregion.nel),femregion.nbases,femregion.nbases,ones(1,femregion.nel));
El.MPrjP_1_loc   = mat2cell(zeros(femregion.nbases,femregion.nbases,femregion.nel),femregion.nbases,femregion.nbases,ones(1,femregion.nel));
                  
El.D1_loc  = mat2cell(zeros(femregion.nbases,femregion.nbases,femregion.nel),femregion.nbases,femregion.nbases,ones(1,femregion.nel));
El.C1_loc  = mat2cell(zeros(femregion.nbases,femregion.nbases,femregion.nel),femregion.nbases,femregion.nbases,ones(1,femregion.nel));

Edge.ABC_R1_loc = mat2cell(zeros(femregion.nbases,femregion.nbases,femregion.nel),femregion.nbases,femregion.nbases,ones(1,femregion.nel));
Edge.ABC_R2_loc = mat2cell(zeros(femregion.nbases,femregion.nbases,femregion.nel),femregion.nbases,femregion.nbases,ones(1,femregion.nel));
Edge.ABC_R3_loc = mat2cell(zeros(femregion.nbases,femregion.nbases,femregion.nel),femregion.nbases,femregion.nbases,ones(1,femregion.nel));
Edge.ABC_R4_loc = mat2cell(zeros(femregion.nbases,femregion.nbases,femregion.nel),femregion.nbases,femregion.nbases,ones(1,femregion.nel));

Edge.ABC_S1_loc = mat2cell(zeros(femregion.nbases,femregion.nbases,femregion.nel),femregion.nbases,femregion.nbases,ones(1,femregion.nel));
Edge.ABC_S2_loc = mat2cell(zeros(femregion.nbases,femregion.nbases,femregion.nel),femregion.nbases,femregion.nbases,ones(1,femregion.nel));
Edge.ABC_S3_loc = mat2cell(zeros(femregion.nbases,femregion.nbases,femregion.nel),femregion.nbases,femregion.nbases,ones(1,femregion.nel));
Edge.ABC_S4_loc = mat2cell(zeros(femregion.nbases,femregion.nbases,femregion.nel),femregion.nbases,femregion.nbases,ones(1,femregion.nel));

Edge.S1_P_loc = mat2cell(zeros(femregion.nbases*max_nedges,femregion.nbases,femregion.nel),femregion.nbases*max_nedges,femregion.nbases,ones(1,femregion.nel));
Edge.S4_P_loc = mat2cell(zeros(femregion.nbases*max_nedges,femregion.nbases,femregion.nel),femregion.nbases*max_nedges,femregion.nbases,ones(1,femregion.nel));

Edge.IT1_loc = mat2cell(zeros(femregion.nbases*max_nedges,femregion.nbases,femregion.nel),femregion.nbases*max_nedges,femregion.nbases,ones(1,femregion.nel));
Edge.IT2_loc = mat2cell(zeros(femregion.nbases*max_nedges,femregion.nbases,femregion.nel),femregion.nbases*max_nedges,femregion.nbases,ones(1,femregion.nel));
...
for ie = 1 : femregion.nel
    ...
    if tag_ie == 'E'
        ...
        % Computation of index for elasticity (for multi-physics simulations)
        ...
        for iTria = 1:size(Tria,1)
            ...
            El.V1_loc{ie} = El.V1_loc{ie} + (dx .* ((par.lam+2*par.mu) .* gradqx))' * gradqx + (dx .* (par.mu .* gradqy))' * gradqy;
            El.V2_loc{ie} = El.V2_loc{ie} + (dx .* (par.lam        .* gradqx))' * gradqy + (dx .* (par.mu .* gradqy))' * gradqx;
            El.V3_loc{ie} = El.V3_loc{ie} + (dx .* (par.lam        .* gradqy))' * gradqx + (dx .* (par.mu .* gradqx))' * gradqy;
            El.V4_loc{ie} = El.V4_loc{ie} + (dx .* ((par.lam+2*par.mu) .* gradqy))' * gradqy + (dx .* (par.mu .* gradqx))' * gradqx;

            El.M1_P_rho_loc{ie} = El.M1_P_rho_loc{ie}  + (dx .* (par.rho_e .* phiq))' * phiq;
            El.MPrjP_1_loc{ie}  = El.MPrjP_1_loc{ie}   + (dx .* phiq)' * phiq;

            El.D1_loc{ie} = El.D1_loc{ie}  + (dx .* (2 * par.rho_e .* par.zeta .* phiq))' * phiq;
...
El.V1_loc = reshape(cell2mat(El.V1_loc),[femregion.nbases,femregion.nbases*femregion.nel]);
El.V2_loc = reshape(cell2mat(El.V2_loc),[femregion.nbases,femregion.nbases*femregion.nel]);
El.V3_loc = reshape(cell2mat(El.V3_loc),[femregion.nbases,femregion.nbases*femregion.nel]);
El.V4_loc = reshape(cell2mat(El.V4_loc),[femregion.nbases,femregion.nbases*femregion.nel]);

El.M1_P_rho_loc  = reshape(cell2mat(El.M1_P_rho_loc),[femregion.nbases,femregion.nbases*femregion.nel]);
El.MPrjP_1_loc   = reshape(cell2mat(El.MPrjP_1_loc),[femregion.nbases,femregion.nbases*femregion.nel]);
                  
El.D1_loc  = reshape(cell2mat(El.D1_loc),[femregion.nbases,femregion.nbases*femregion.nel]);
El.C1_loc  = reshape(cell2mat(El.C1_loc),[femregion.nbases,femregion.nbases*femregion.nel]);

Edge.ABC_R1_loc = reshape(cell2mat(Edge.ABC_R1_loc),[femregion.nbases,femregion.nbases*femregion.nel]);
Edge.ABC_R2_loc = reshape(cell2mat(Edge.ABC_R2_loc),[femregion.nbases,femregion.nbases*femregion.nel]);
Edge.ABC_R3_loc = reshape(cell2mat(Edge.ABC_R3_loc),[femregion.nbases,femregion.nbases*femregion.nel]);
Edge.ABC_R4_loc = reshape(cell2mat(Edge.ABC_R4_loc),[femregion.nbases,femregion.nbases*femregion.nel]);

Edge.ABC_S1_loc = reshape(cell2mat(Edge.ABC_S1_loc),[femregion.nbases,femregion.nbases*femregion.nel]);
Edge.ABC_S2_loc = reshape(cell2mat(Edge.ABC_S2_loc),[femregion.nbases,femregion.nbases*femregion.nel]);
Edge.ABC_S3_loc = reshape(cell2mat(Edge.ABC_S3_loc),[femregion.nbases,femregion.nbases*femregion.nel]);
Edge.ABC_S4_loc = reshape(cell2mat(Edge.ABC_S4_loc),[femregion.nbases,femregion.nbases*femregion.nel]);
...
Edge.S1_P_loc  = reshape(cell2mat(Edge.S1_P_loc),[femregion.nbases,femregion.nel*max_nedges*femregion.nbases]);
Edge.S4_P_loc  = reshape(cell2mat(Edge.S4_P_loc),[femregion.nbases,femregion.nel*max_nedges*femregion.nbases]);

Edge.IT1_loc  = reshape(cell2mat(Edge.IT1_loc),[femregion.nbases,femregion.nel*max_nedges*femregion.nbases]);
Edge.IT2_loc  = reshape(cell2mat(Edge.IT2_loc),[femregion.nbases,femregion.nel*max_nedges*femregion.nbases]);
Edge.IT3_loc  = reshape(cell2mat(Edge.IT3_loc),[femregion.nbases,femregion.nel*max_nedges*femregion.nbases]);
Edge.IT4_loc  = reshape(cell2mat(Edge.IT4_loc),[femregion.nbases,femregion.nel*max_nedges*femregion.nbases]);
...
A.V1 = sparse(ii_index,jj_index,El.V1_loc,femregion.ndof,femregion.ndof);
A.V2 = sparse(ii_index,jj_index,El.V2_loc,femregion.ndof,femregion.ndof);
A.V3 = sparse(ii_index,jj_index,El.V3_loc,femregion.ndof,femregion.ndof);
A.V4 = sparse(ii_index,jj_index,El.V4_loc,femregion.ndof,femregion.ndof);

A.M1_P_rho  = sparse(ii_index,jj_index,El.M1_P_rho_loc,femregion.ndof,femregion.ndof);
A.MPrjP_1   = sparse(ii_index,jj_index,El.MPrjP_1_loc,femregion.ndof,femregion.ndof);
                  
A.D1  = sparse(ii_index,jj_index,El.D1_loc,femregion.ndof,femregion.ndof);
A.C1  = sparse(ii_index,jj_index,El.C1_loc,femregion.ndof,femregion.ndof);

A.ABC_R1   = sparse(ii_index,jj_index,Edge.ABC_R1_loc,femregion.ndof,femregion.ndof);
A.ABC_R2   = sparse(ii_index,jj_index,Edge.ABC_R2_loc,femregion.ndof,femregion.ndof);
A.ABC_R3   = sparse(ii_index,jj_index,Edge.ABC_R3_loc,femregion.ndof,femregion.ndof);
A.ABC_R4   = sparse(ii_index,jj_index,Edge.ABC_R4_loc,femregion.ndof,femregion.ndof);

A.ABC_S1   = sparse(ii_index,jj_index,Edge.ABC_S1_loc,femregion.ndof,femregion.ndof);
A.ABC_S2   = sparse(ii_index,jj_index,Edge.ABC_S2_loc,femregion.ndof,femregion.ndof);
A.ABC_S3   = sparse(ii_index,jj_index,Edge.ABC_S3_loc,femregion.ndof,femregion.ndof);
A.ABC_S4   = sparse(ii_index,jj_index,Edge.ABC_S4_loc,femregion.ndof,femregion.ndof);

A.S1_P     = sparse(ii_index_neigh,jj_index_neigh,Edge.S1_P_loc,femregion.ndof,femregion.ndof);
A.S2_P     = sparse(femregion.ndof,femregion.ndof);
A.S3_P     = sparse(femregion.ndof,femregion.ndof);
A.S4_P     = sparse(ii_index_neigh,jj_index_neigh,Edge.S4_P_loc,femregion.ndof,femregion.ndof);

A.IT1_P    = sparse(ii_index_neigh,jj_index_neigh,Edge.IT1_loc,femregion.ndof,femregion.ndof);
A.IT2_P    = sparse(ii_index_neigh,jj_index_neigh,Edge.IT2_loc,femregion.ndof,femregion.ndof);
A.IT3_P    = sparse(ii_index_neigh,jj_index_neigh,Edge.IT3_loc,femregion.ndof,femregion.ndof);
A.IT4_P    = sparse(ii_index_neigh,jj_index_neigh,Edge.IT4_loc,femregion.ndof,femregion.ndof);
